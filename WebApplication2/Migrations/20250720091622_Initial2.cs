    ...
    public partial class Initial2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoteEntityModelTagEntity", x => new { x.NotesId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_NoteEntityModelTagEntity_Notes_NotesId",
                        column: x => x.NotesId,
                        principalTable: "Notes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NoteEntityModelTagEntity_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteEntityModelTagEntity_TagsId",
                table: "NoteEntityModelTagEntity",
                column: "TagsId");
